Don't lought ;-) . I configured it like this, because after a shutdown all the external IPs have changed and so the old DNS-Names have been set to the internal IPs.
